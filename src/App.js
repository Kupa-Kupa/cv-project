...
const App = () => {
  // set state of personal info in form
  ...
  // set state of experience info in form
  ...
  // set state of education info in form
  ...
  return (
    <div className="appContainer">
      <section>
        <Input
          handlePersonalChange={handlePersonalInfo}
          handleExperienceChange={handleExperienceInfo}
          handleEducationChange={handleEducationInfo}
